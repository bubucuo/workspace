...
window.onload = function () {
          ...
          var lottery = new Lottery('lotteryContainer', 'image/go_prize.png', 'image', 300, 100, drawPercent);

          lottery.init('image/go_use_bg.png', 'text');
          ...
          function drawPercent(percent) {
              ...
              //if (percent > "90") _img.style.display = "";
